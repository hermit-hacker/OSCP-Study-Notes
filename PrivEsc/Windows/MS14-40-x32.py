...
<script type="text/javascript">window.addEventListener('DOMContentLoaded',function(){var v=archive_analytics.values;v.service='wb';v.server_name='wwwb-app104.us.archive.org';v.server_ms=196;archive_analytics.send_pageview({});});</script><link rel="stylesheet" type="text/css" href="/_static/css/banner-styles.css" />
  ...
  <div style="position:relative;">
    ...
    <div class="r" style="float:right;">
      <div id="wm-btns" style="text-align:right;height:25px;">
          ...
          <a href="#"
             onclick="__wm.saveSnapshot('http://www.bhafsec.com/files/windows/MS14-40-x32.py', '20160830190525')"
	...
	<a href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=https://web.archive.org/web/20160830190525/http://www.bhafsec.com/files/windows/MS14-40-x32.py', '', 'height=400,width=600'); return false;" title="Share on Facebook" style="margin-right:5px;" target="_blank"><span class="iconochive-facebook" style="color:#3b5998;font-size:160%;"></span></a>
	<a href="#" onclick="window.open('https://twitter.com/intent/tweet?text=https://web.archive.org/web/20160830190525/http://www.bhafsec.com/files/windows/MS14-40-x32.py&amp;via=internetarchive', '', 'height=400,width=600'); return false;" title="Share on Twitter" style="margin-right:5px;" target="_blank"><span class="iconochive-twitter" style="color:#1dcaff;font-size:160%;"></span></a>
      </div>
    </div>
    <table class="c" style="">
      <tbody>
	<tr>
	  <td class="u" colspan="2">
	    <form target="_top" method="get" action="/web/submit" name="wmtb" id="wmtb"><input type="text" name="url" id="wmtbURL" value="http://www.bhafsec.com/files/windows/MS14-40-x32.py" onfocus="this.focus();this.select();" /><input type="hidden" name="type" value="replay" /><input type="hidden" name="date" value="20160830190525" /><input type="submit" value="Go" /></form>
	  </td>
	  <td class="n" rowspan="2" style="width:110px;">
		...
		<tr class="m">
		  ...
		  <td class="c" id="displayMonthEl" title="You are here: 19:05:25 Aug 30, 2016">AUG</td>
		...
		<tr class="d">
		  ...
		  <td class="c" id="displayDayEl" style="width:34px;font-size:24px;white-space:nowrap;" title="You are here: 19:05:25 Aug 30, 2016">30</td>
		...
		<tr class="y">
		  ...
		  <td class="c" id="displayYearEl" title="You are here: 19:05:25 Aug 30, 2016">2016</td>
	...
	<tr>
	  <td class="s">
	    	    <div id="wm-nav-captures">
	      	      <a class="t" href="/web/20160830190525*/http://www.bhafsec.com/files/windows/MS14-40-x32.py" title="See a list of every capture for this URL">2 captures</a>
	      <div class="r" title="Timespan for captures of this URL">30 Aug 2016 - 30 Aug 2016</div>
	      </div>
	  </td>
	  <td class="k">
...
__wm.bt(600,27,25,2,"web","http://www.bhafsec.com/files/windows/MS14-40-x32.py","2016-08-30",1996,"/_static/",['css/banner-styles.css','css/iconochive.css']);
</script>
<!-- END WAYBACK TOOLBAR INSERT --><iframe id="playback" src="https://web.archive.org/web/20160830190525if_/http://www.bhafsec.com/files/windows/MS14-40-x32.py" frameborder="0" style="position:absolute;top:65px;left:0;width:100%;">
</iframe>
